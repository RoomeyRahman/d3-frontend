...
export default function HeatmapChart({ data, width = 800, height = 600 }: HeatmapProps) {
  ...
  useEffect(() => {
    ...
    // Convert network data to heatmap matrix
    const { matrix, nodes: sortedNodes } = convertToMatrix(data);
  ...
  return (
    <div style={{ position: 'relative', display: 'inline-block' }}>
      ...
      <div style={{ 
        ...
        <strong>Controls:</strong> Scroll to zoom | Drag to pan | Hover cells for values
      </div>
    </div>
  );
}
...
// Convert network data to heatmap matrix
function convertToMatrix(data: NetworkData) {
